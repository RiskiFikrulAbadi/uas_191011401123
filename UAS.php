...
?> 
<br><br><br> 
<table width=1000px height="700px" align=center cellpadding=1 cellspacing=1 
border=1> 
 <tr> 
 <th width="199" height="100" valign="top"> 
 <table border=5 cellpadding=1 cellspacing=1> 
 <tr valign="middle"><td bgcolor=5c743d width="198" height="30" ><b><font 
color=d5edb3><b>Menu Operator</b></font></b></td> </tr> 
 <tr valign="middle"><td height="25" bgcolor=d5edb3><a 
href=user.php><b><font color=5c743d>Home</font></b></a></td></tr> 
 <tr valign="middle"><td height="25" bgcolor=d5edb3><a 
href=olahdata_user.php><b><font color=5c743d>Olah Data</font></b></a></td></tr> 
 <tr valign="middle"><td height="25" bgcolor=d5edb3><a 
href=lihatdata_user.php><b><font color=5c743d>Lihat Data</font></b></a></td></tr> 
 <tr valign="middle"><td height="25" bgcolor=d5edb3><a 
href=ubahpsw_user.php><b><font color=5c743d>Ubah Password</font></b></a> 
 </td></tr> 
 <tr valign="middle"><td height="25" bgcolor=d5edb3><a 
href=logout.php><b><font color=5c743d>Logout</font></b></a></td></tr> 
 </table> 
 </th> 
<td width="792" rowspan="2" valign=top align="justify"><font color=5c743d> 
<?php 
$mulai=$_POST['mulai']; 
$masa=$_POST['masa']; 
$masa2=$masa-1; 
$hari_ke=$mulai+$masa2; 
$max_permintaan_temp=mysql_query("select max(permintaan) as a from permintaan 
...
$min_persediaan_temp=mysql_query("select min(persediaan) as a from persediaan where 
...
//[R2] IF Permintaan TURUN AND Persediaan SEDANG THEN Produksi Barang 
BERKURANG 
$alfa_dua=min($miu_pmt_turun,$miu_psd_sedang); 
$z2=$max_produksi-($max_produksi-$min_produksi)*$alfa_dua; 
//[R3] IF Permintaan TURUN AND Persediaan SEDIKIT THEN Produksi Barang 
BERKURANG 
$alfa_tiga=min($miu_pmt_turun,$miu_psd_sedikit); 
$z3=$max_produksi-($max_produksi-$min_produksi)*$alfa_tiga; 
//[R4] IF Permintaan TETAP AND Persediaan BANYAK THEN Produksi Barang 
BERKURANG 
$alfa_empat=min($miu_pmt_tetap,$miu_psd_banyak); 
$z4=$max_produksi-($max_produksi-$min_produksi)*$alfa_empat; 
//[R5] IF Permintaan TETAP AND Persediaan SEDANG THEN Produksi Barang 
TETAP 
$alfa_lima=min($miu_pmt_tetap,$miu_psd_sedang); 
$z5=$zt; 
//[R6] IF Permintaan TETAP AND Persediaan SEDIKIT THEN Produksi Barang 
BERTAMBAH 
...
print ("<b>Data Selama $masa Hari, mulai hari ke $mulai sampai hari ke 
$hari_ke</b><br>"); 
print ("Permintaan Maksimum=$max_permintaan<br>"); 
133 
echo "Permintaan Minimum=$min_permintaan<br>"; 
print ("Titik tengah permintaan=$xt<br>"); 
echo "Persediaan Maksimum=$max_persediaan<br>"; 
echo "Persediaan Minimum=$min_persediaan<br>"; 
print ("Titik tengah persediaan=$yt<br>"); 
echo "Produksi Maksimum=$max_produksi<br>"; 
echo "Produksi Minimum=$min_produksi<br>"; 
print ("Titik tengah produksi=$zt<br><br>"); 
echo "<b>Data saat ini:</b><br>"; 
echo "Permintaan=$x<br>"; 
echo "Persediaan=$y<br><br>"; 
print("<b>Hasil Perhitungan Variabel-Variabel</b><br><br>"); 
print("<b>miu</b><br>"); 
print("miu permintaan turun=$miu_pmt_turun<br>"); 
print ("miu permintaan tetap=$miu_pmt_tetap<br>"); 
print("miu permintaan naik=$miu_pmt_naik<br>"); 
print("miu persediaan sedikit=$miu_psd_sedikit<br>"); 
print("miu persediaan sedang=$miu_psd_sedang<br>"); 
print("miu persediaan banyak=$miu_psd_banyak<br><br>"); 
print("<b>Nilai alfa untuk setiap aturan</b><br>"); 
print("alfa 1 = min($miu_pmt_turun,$miu_psd_banyak)=$alfa_satu<br>"); 
print("alfa 2 = min($miu_pmt_turun,$miu_psd_sedang)=$alfa_dua<br>"); 
print("alfa 3 = min($miu_pmt_turun, $miu_psd_sedikit)=$alfa_tiga<br>"); 
print("alfa 4 = min($miu_pmt_tetap,$miu_psd_banyak)=$alfa_empat<br>"); 
print("alfa 5 = min($miu_pmt_tetap,$miu_psd_sedang)=$alfa_lima<br>"); 
print("alfa 6 = min($miu_pmt_tetap, $miu_psd_sedikit)=$alfa_enam<br>"); 
print("alfa 7 = min($miu_pmt_naik, $miu_psd_banyak)=$alfa_tujuh<br>"); 
print("alfa 8 = min($miu_pmt_naik, $miu_psd_sedang)=$alfa_delapan<br>"); 
print("alfa 9 = min($miu_pmt_naik, $miu_psd_sedikit)=$alfa_sembilan<br><br>"); 
...
$alfaz_total=$alfaz1+$alfaz2+$alfaz3+$alfaz4+$alfaz5+$alfaz6+$alfaz7+$alfaz8+$alfaz
9; 
134 
$alfa_total=$alfa_satu+$alfa_dua+$alfa_tiga+$alfa_empat+$alfa_lima+$alfa_enam+$alf
a_tujuh+$alfa_delapan+$alfa_sembilan; 
print ("<b>Nilai alfa.z dari setiap aturan</b><br>"); 
...
$Zcari=($alfa_satu*$z1+$alfa_dua*$z2+$alfa_tiga*$z3+$alfa_empat*$z4+$alfa_lima*$
z5+$alfa_enam*$z6+$alfa_tujuh*$z7+$alfa_delapan*$z8+$alfa_sembilan*$z9)/($alfa_s
atu+$alfa_dua+$alfa_tiga+$alfa_empat+$alfa_lima+$alfa_enam+$alfa_tujuh+$alfa_dela
pan+$alfa_sembilan); 
print ("Jadi, Menurut perhitungan metode <i>Tsukamoto</i>, makanan kaleng merk Zpro yang akan diproduksi 
oleh perusahaan makanan kaleng X sebanyak: <b>$Zcari</b> kemasan<br><br>"); 
?> 
<?php 
$running=set_time_limit(0); 
echo "Waktu yang dibutuhkan untuk running program=<b>$running detik</b>"; 
?> 
</font></td> 
 </tr> 
 <tr> 
